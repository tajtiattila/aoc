...
// FindPath finds the shortest path to the destination using the A* algorithm.
func FindPath(start Point, adjacent AdjacentFunc) (path []Point, cost int) {
